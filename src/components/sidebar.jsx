        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Khushbu Koshti</a></h1>
              <span className="email"><i className="icon-mail"></i> kostikhushbu1234@gmail.com</span>
            </div>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#gallary" data-nav-section="gallary">Gallary</a></li>
                </ul>
              </div>
            </nav>
